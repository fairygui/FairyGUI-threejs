namespace fgui {
    let s_vec2: THREE.Vector2 = new THREE.Vector2();
    ...
    export class GSlider extends GComponent {
        ...
        private _clickPos: THREE.Vector2;
        ...
        private __gripTouchMove(evt: Event): void {
            ...
            var pt: THREE.Vector2 = this.globalToLocal(evt.input.x, evt.input.y, s_vec2);
        ...
        private __barTouchBegin(evt: Event): void {
            ...
            var pt: THREE.Vector2 = this._gripObject.globalToLocal(evt.input.x, evt.input.y, s_vec2);
