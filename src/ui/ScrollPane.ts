namespace fgui
{
    ...
    var s_endPos: THREE.Vector2 = new THREE.Vector2();
    var s_oldChange: THREE.Vector2 = new THREE.Vector2();
    ...
    export class ScrollPane {
        ...
        private _viewSize: THREE.Vector2;
        private _contentSize: THREE.Vector2;
        private _overlapSize: THREE.Vector2;
        private _pageSize: THREE.Vector2;
        private _containerPos: THREE.Vector2;
        private _beginTouchPos: THREE.Vector2;
        private _lastTouchPos: THREE.Vector2;
        private _lastTouchGlobalPos: THREE.Vector2;
        ...
        private _tweenTime: THREE.Vector2;
        private _tweenDuration: THREE.Vector2;
        private _tweenStart: THREE.Vector2;
        private _tweenChange: THREE.Vector2;
        ...
        private __touchBegin(evt: Event): void {
            ...
            var pt: THREE.Vector2 = this._owner.globalToLocal(evt.input.x, evt.input.y, s_vec2);
        ...
        private __touchMove(evt: Event): void {
            ...
            var pt: THREE.Vector2 = this._owner.globalToLocal(evt.input.x, evt.input.y);
        ...
        private loopCheckingTarget(endPos: THREE.Vector2): void {
            if (this._loop == 1)
        ...
        private loopCheckingTarget2(endPos: THREE.Vector2, axis: string): void {
            var halfSize: number;
            var tmp: number;
            if (endPos[axis] > 0) {
        ...
        private alignPosition(pos: THREE.Vector2, inertialScrolling: boolean): void {
            if (this._pageMode) {
                ...
                var pt: THREE.Vector2 = this._owner.getSnappingPositionWithDir(-pos.x, -pos.y, xDir, yDir, s_vec2);
        ...
        private updateTargetAndDuration(orignPos: THREE.Vector2, resultPos: THREE.Vector2): void {
