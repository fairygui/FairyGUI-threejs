namespace fgui {
    ...
    export class GList extends GComponent {
        ...
        private _itemSize: THREE.Vector2;
        ...
        public get virtualItemSize(): THREE.Vector2 {
            return this._itemSize;
        }

        public set virtualItemSize(value: THREE.Vector2) {
            if (this._virtual) {
        ...
        private __clickItem(evt: Event): void {
            ...
            var item: GObject = GObject.cast(evt.sender);
        ...
        public getSnappingPositionWithDir(xValue: number, yValue: number, xDir: number, yDir: number, resultPoint?: THREE.Vector2): THREE.Vector2 {
            if (this._virtual) {
                if (!resultPoint)
