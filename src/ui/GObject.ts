namespace fgui {
    ...
    export class GObject {
        ...
        public localToGlobal(ax?: number, ay?: number, result?: THREE.Vector2): THREE.Vector2 {
            ax = ax || 0;
            ay = ay || 0;
        ...
        public globalToLocal(ax?: number, ay?: number, result?: THREE.Vector2): THREE.Vector2 {
            ax = ax || 0;
            ay = ay || 0;
        ...
        public localToRoot(ax: number, ay: number, result?: THREE.Vector2): THREE.Vector2 {
            let r = Decls.GRoot.findFor(this);
            let pt = this.localToGlobal(ax, ay, result);
            return r.globalToLocal(pt.x, pt.y, pt);
        }

        public rootToLocal(ax: number, ay: number, result?: THREE.Vector2): THREE.Vector2 {
            let r = Decls.GRoot.findFor(this);
        ...
        public localToGlobalRect(ax: number, ay: number, aWidth: number, aHeight: number, result?: Rect): Rect {
            ...
            var pt: THREE.Vector2 = this.localToGlobal(ax, ay, s_vec2);
            result.x = pt.x;
            result.y = pt.y;
        ...
        public globalToLocalRect(ax: number, ay: number, aWidth: number, aHeight: number, result?: Rect): Rect {
            ...
            var pt: THREE.Vector2 = this.globalToLocal(ax, ay, s_vec2);
            result.x = pt.x;
            result.y = pt.y;
        ...
        //drag support
        //-------------------------------------------------------------------
        private _dragTouchStartPos: THREE.Vector2 = new THREE.Vector2();
    ...
    var sGlobalDragStart: THREE.Vector2 = new THREE.Vector2();
