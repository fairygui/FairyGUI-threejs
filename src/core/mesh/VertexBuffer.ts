...
namespace fgui {
    ...
    export class VertexBuffer {
        ...
        public textureSize: THREE.Vector2;
        ...
        public addQuad(vertRect: Rect, uvRect?: Rect | Array<THREE.Vector2>, color?: Color4): void {
            uvBuf.length = 0;
            if (uvRect) {
        ...
        public getPosition(index: number, ret: THREE.Vector3): THREE.Vector3 {
            if (index < 0)
