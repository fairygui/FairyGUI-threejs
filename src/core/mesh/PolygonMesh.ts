namespace fgui {
    ...
    var a: THREE.Vector2 = new THREE.Vector2();
    var b: THREE.Vector2 = new THREE.Vector2();
    var c: THREE.Vector2 = new THREE.Vector2();
    var p: THREE.Vector2 = new THREE.Vector2();
    var p0: THREE.Vector3 = new THREE.Vector3();
    var p1: THREE.Vector3 = new THREE.Vector3();
    var p3: THREE.Vector3 = new THREE.Vector3();
    var lineVector: THREE.Vector3 = new THREE.Vector3();
    var widthVector: THREE.Vector3 = new THREE.Vector3();
    ...
    export class PolygonMesh implements IMeshFactory, IHitTest {
        ...
        private isPointInTriangle(p: THREE.Vector2, a: THREE.Vector2, b: THREE.Vector2, c: THREE.Vector2): boolean {
            // From Starling
