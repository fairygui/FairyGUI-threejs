...
namespace fgui {
    ...
    export class NGraphics implements IMeshFactory {
        ...
        public constructor(owner: THREE.Object3D) {
        ...
        public set color(value: number) {
            if (this._color != value) {
                ...
                if (!this._meshDirty) {
                    s_col.setHex(value);
                    let attr: THREE.BufferAttribute = <THREE.BufferAttribute>this._geometry.attributes["color"];
                    if (attr) {
        ...
        private writeAttribute(gm: THREE.BufferGeometry, name: string, arr: Array<number>, itemSize: number): void {
            let attr: THREE.BufferAttribute = <THREE.BufferAttribute>gm.attributes[name];
        ...
        private writeIndexAttribute(gm: THREE.BufferGeometry, arr: Array<number>): void {
            let attr: THREE.BufferAttribute = <THREE.BufferAttribute>gm.index;
            if (!attr || !attr.isBufferAttribute || attr.array.length < arr.length) {
