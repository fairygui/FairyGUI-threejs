namespace fgui {
    ...
    export class NTexture {
        ...
        public originalSize: THREE.Vector2;

        private _root: NTexture;
        private _nativeTexture: THREE.Texture;

        public constructor(texture?: THREE.Texture, xScale?: number, yScale?: number) {
            xScale = xScale || 1;
            yScale = yScale || 1;
        ...
        public createSubTexture(region: Rect, rotated?: boolean, offset?: THREE.Vector2, originalSize?: THREE.Vector2): NTexture {
            let nt = new NTexture();
            nt._root = this;
        ...
        public get nativeTexture(): THREE.Texture {
        ...
        public getUV(uv: Array<THREE.Vector2>) {
        ...
        public reload(nativeTexture: THREE.Texture) {
            if (this._root != this)
